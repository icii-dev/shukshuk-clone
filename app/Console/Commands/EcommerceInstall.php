...
class EcommerceInstall extends Command
{
    ...
    protected function proceed()
    {
        ...
        try {
            ...
            $this->error('Algolia credentials incorrect. Your products table is NOT seeded correctly. If you are not using Algolia, remove Laravel\Scout\Searchable from App\Model\Product');
        }
