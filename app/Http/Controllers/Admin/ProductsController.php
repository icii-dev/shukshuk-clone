...
class ProductsController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return Voyager::view('admin.products.browse', compact(
            'dataType',
            'dataTypeContent',
            'isModelTranslatable',
            'search',
    ...
    public function edit(Request $request, $id)
    {
        ...
        return Voyager::view('admin.products.edit-add',
            compact('dataType', 'dataTypeContent', 'isModelTranslatable', 'allCategories', 'categoriesForProduct'));
    }

    /**
     * Active/Deactive a product
    ...
    public function status(Request $request, $id, $status)
    {
        ...
        // Check permission
        $this->authorize('edit', $dataTypeContent);
//        if((int)$status === Product::STATUS_ACTIVE){
//            $dataTypeContent->status = Product::STATUS_ACTIVE;
//        }elseif ((int)$status === Product::STATUS_DEACTIVE){
//            $dataTypeContent->status = Product::STATUS_DEACTIVE;
//        }
        $dataTypeContent->status = (int)$status;
        $dataTypeContent->save();
        return redirect()->route('voyager.products.index');
    }

    /**
     * Featured ON/OFF a product
     * @param Request $request
     * @param $id
     * @return \Illuminate\Contracts\View\Factory|\Illuminate\View\View|mixed
     * @throws \Illuminate\Auth\Access\AuthorizationException
    ...
    public function featured(Request $request, $id, $status)
    {
        $slug = $this->getSlug($request);
        ...
        // Check permission
        $this->authorize('edit', $dataTypeContent);
        if((int)$status === Product::FEATURED_ON){
            $dataTypeContent->featured = Product::FEATURED_ON;
        }elseif ((int)$status === Product::FEATURED_OFF){
            $dataTypeContent->featured = Product::FEATURED_OFF;
        }
        $dataTypeContent->save();
        return redirect()->route('voyager.products.index');
    }
