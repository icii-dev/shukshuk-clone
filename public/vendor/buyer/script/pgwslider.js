    ...
    $.fn.pgwSlider = function(options) {
        ...
        var slideElement = function(element, direction) {
            ...
            if (pgwSlider.currentSlide == 0) {
                ...
                pgwSlider.plugin.find('.ps-list > li.elt_1').css({'opacity':'1','border':'2px solid #413EC1'});
                finishElement(element);
                ...
                nextElement.css('position', 'absolute').css('left', nextOrigin).css('opacity', 1).show().animate({
                    ...
                    // Display new element
                    pgwSlider.plugin.find('.ps-list > li').css({'opacity':'0.6','border':'none'});
                    pgwSlider.plugin.find('.ps-list > li.elt_' + element.id).css({'opacity':'1','border':'2px solid #413EC1'});
