...
{{--    <link rel="stylesheet" href="{{asset('css/reset.css')}}">--}}
    ...
    <link rel="stylesheet" href="{{ asset("vendor/buyer/Css/customLib.css") }}">
    ...
    function updateCartStatus(data) {
        ...
        $.each( data, function( key, value ) {
            ...
            code += (value.options.discount>0)?"<div class=\"col-6 d-flex justify-content-end\">\n" +
                "                    <div class=\"sale-off text-center truncate-overflow-one\"><span style=\"font-size: 12px\">"+printDiscount(value.options.discount)+"</span></div>\n" +
                "                </div>":"";
            code += "           </div>";
...
<script type="text/javascript">
    function printItemProduct(value) {
        ...
        htmlCode += "<div class=\"padding-col-product col-md-4 col-sm-6 web-block\">\n" +
        ...
        htmlCode += "<div class=\"padding-col-product col-md-4 col-sm-6 mobi-block\">\n" +
            "                        <div class=\"card card-product\">\n" +
            "                            <a href=\""+config.routes.productDetail+value.slug+"\">\n" +
            "                                <img class=\"img-fluid card-img-top\" src=\""+config.routes.url+value.image+"\" alt=\"...\" onerror=\"this.src=\'"+img+"\'\">\n" +
            "</a>\n";
        ...
        htmlCode += "                            <div class=\"card-body\">\n" +
            "                                <p class=\"card-text seller-name truncate-overflow-one\" style=\"margin-bottom: 0\"><a href=\""+config.routes.store+value.store.slug+"\">"+value.store.name+"</a></p>\n";
        if (disPrice !== price){
            htmlCode +=    "                                    <h3 class=\"truncate-overflow-one\" style=\"margin-bottom: 10px;\"><a class=\"link-product\" href=\""+config.routes.productDetail+value.slug+"\">"+value.name+"</a></h3>\n";
        }else {
            htmlCode +=    "                                    <h3 class=\"truncate-overflow-two\" style=\"margin-bottom: 10px;\"><a class=\"link-product\" href=\""+config.routes.productDetail+value.slug+"\">"+value.name+"</a></h3>\n";
        }
        htmlCode += (value.discount)?"                                    <p class=\"text-sale-off truncate-overflow-one\">"+moneyFormat(value.price)+"</p>\n":"";
        if (disPrice !== price){
            htmlCode += "                                    <p class=\"card-text text-muted truncate-overflow-one link-product\"><a href=\"#\" style=\"color: #EB4242;\">"+showMoney(value.presentPrice)+"</a></p>\n" +
                "                                </div>\n" +
                "                            </div>\n" +
                "                        </div>\n" +
                "                    </div>";
        }else {
            htmlCode += "                                    <p class=\"card-text text-muted truncate-overflow-one link-product\"><a href=\"#\">"+showMoney(value.presentPrice)+"</a></p>\n" +
                "                                </div>\n" +
                "                            </div>\n" +
                "                    </div>";
        }
