...
--
-- Máy chủ: localhost
-- Thời gian đã tạo: Th1 03, 2020 lúc 10:27 AM
...
ALTER TABLE `address_districts_indo`
  ADD PRIMARY KEY (`id`),
  ADD KEY `address_districts_indo_id_index` (`regency_id`);
...
ALTER TABLE `address_regencies_indo`
  ADD PRIMARY KEY (`id`),
  ADD KEY `address_regencies_indo_province_id_index` (`province_id`);
...
--
-- Các ràng buộc cho bảng `address_districts_indo`
--
ALTER TABLE `address_districts_indo`
  ADD CONSTRAINT `address_districts_indo_regency_id_foreign` FOREIGN KEY (`regency_id`) REFERENCES `address_regencies_indo` (`id`);

--
-- Các ràng buộc cho bảng `address_regencies_indo`
--
ALTER TABLE `address_regencies_indo`
  ADD CONSTRAINT `address_regencies_indo_province_id_foreign` FOREIGN KEY (`province_id`) REFERENCES `address_provinces_indo` (`id`);
COMMIT;
